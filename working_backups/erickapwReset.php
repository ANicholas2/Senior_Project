...
<form action="phpPwReset.php" method="POST" class="w3-container w3-card-4 w3-text-metro-dark-blue w3-margin">
    ...
    <div class="w3-row w3-section">
        <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-check-circle"></i></div>
            <div class="w3-rest">
                <input class="w3-input w3-border w3-round-large" name="myReEnter" type="text" placeholder="ReEnter Password">
            </div>
        </div>
    </div>
...
<!--<div class="w3-container">    
    <div class="w3-bar">-->
        ...
        <button class="w3-button w3-bar-item w3-round-large w3-white w3-ripple w3-margin-bottom w3-hover-green" style="width:50%" type="" onclick="window.location.href='https://artemis.cs.csub.edu/~runnerpp/project/resetPassword.php';"><i>New Password?</i></button>
    </div>
</div>-->
